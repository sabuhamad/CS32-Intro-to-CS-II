...
typedef int GuestType; // This can change to other types such
...
class WeddingGuest
{
  public:
    ...
    private:
    struct Node //define Node structure that stores guest data
        {
            std::string first;
            std::string last;
            GuestType type;
    ...
    int m_size = 0; //counts number of nodes in list
